...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('web_id', models.CharField(help_text='formate: required, unique', max_length=50, unique=True, verbose_name='Product website ID')),
                ('slug', models.SlugField(help_text='formate: required, letters, numbers, underscores, or hyphens', max_length=100, verbose_name='product safe URL')),
                ('name', models.CharField(help_text='format: required, max-150', max_length=150, unique=True, verbose_name='product name')),
