...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='format: required, max-50', max_length=50, verbose_name='category name')),
                ('slug', models.SlugField(help_text='format: required, letters, numbers, underscore, or hyphens', max_length=100, verbose_name='category safe URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('web_id', models.CharField(help_text='formate: required, unique', max_length=100, unique=True, verbose_name='Product website ID')),
                ('slug', models.SlugField(help_text='formate: required, letters, numbers, underscores, or hyphens', max_length=150, verbose_name='product safe URL')),
                ('name', models.CharField(help_text='format: required, max-150', max_length=200, unique=True, verbose_name='product name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attributevalues', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='productattributevaluess', to='inventory.productattributevalue')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, help_text='format: product visible = true by default', verbose_name='product visibility')),
                ('is_default', models.BooleanField(default=False, help_text='format: true=this product is visible', verbose_name='default selection')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='producttypeattributes', through='inventory.ProductTypeAttribute', to='inventory.productattribute'),
        ),
        migrations.AddField(
